...
public class EnrolStudentActivity extends AppCompatActivity {
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                        ...
                        studentRef.child("section").setValue(section);
                    }
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter<>(EnrolStudentActivity.this,
                ...
                myRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for(DataSnapshot child: dataSnapshot.getChildren()){
                            ...
                            if(assigned != null && assigned != true && !approved && currentStd){
