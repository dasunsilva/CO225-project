...
public class MarkAttendanceActivity extends AppCompatActivity {
        ...
        myRef.orderByChild("studentID").equalTo(studentId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                    ...
                    // Set the attendance record within the attendance field using
                    attendanceRef.child(attendanceID).setValue(attendanceData);

                    // Check if the student is absent or not
                    if (!isPresent) {
    ...
    public void sendNotification(String recipientToken) {
        RemoteMessage.Builder builder = new RemoteMessage.Builder("campaign").setMessageId(Integer.toString(0)).addData("title", "New Campaign").addData("body", "Check out our latest offers!");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot child: dataSnapshot.getChildren()){
                    ...
                    if(approved && currentStd && assigned && grade.equals(teacherGrade)){
